...
class FloatingIp extends Model
{
    ...
    public static function parse($input): FloatingIp
    {
        ...
        return new self($input->id, $input->description, $input->ip, $input->type, $input->server, $input->dns_ptr, Location::parse($input->home_location), $input->blocked, Protection::parse($input->protection), $input->name);
    }
}
